...
class OutboxRepository(
    ...
    fun updateStatusBatch(entities: Collection<OutboxEntity>) {
    ...
    fun insertAll(entities: Collection<OutboxEntity>) {
        val batchParams = entities.map { outbox ->
            MapSqlParameterSource()
                .addValue("entity", outbox.entity)
    ...
    fun findAndLockNextBatchWhereEntity(entity: String, limit: Int): List<OutboxEntity> {
