...
import org.bazar.space.util.rest.BazarAuthorizationFeignClient
...
class SpaceControllerTest: BaseWebTest() {
    ...
    fun getAllUsersEnriched_shouldReturnOk() {
        ...
        val authenticatedUser = initDataHelper.createUser(spaceId, UUID.fromString("fd71e64e-edb2-4ecb-bc90-7f27c34e0af7"))
